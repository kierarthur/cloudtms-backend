...
DO $local_only$
BEGIN
  IF current_database() NOT IN ('rota_clear_proof','rota_calendar_proof','rota_continuous_proof','rota_removal_proof','rota_daily_first_proof','rota_daily_recovery_proof')
