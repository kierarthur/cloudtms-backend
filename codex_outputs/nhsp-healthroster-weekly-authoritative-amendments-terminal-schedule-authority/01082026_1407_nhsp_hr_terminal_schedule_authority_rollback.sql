-- TEST rollback for terminal schedule authority helper change.
-- Captured from canonical backend commit 1952d506d2fd06efef29721e3b845928bb14f850.
-- Pre-install live pg_get_functiondef MD5: feaf3ed9910f2dc0f8132b406f8f5cd0.
-- Restores only public._import_review_effective_invoice_balance_core_v1(uuid,jsonb,integer,integer,integer,integer).
