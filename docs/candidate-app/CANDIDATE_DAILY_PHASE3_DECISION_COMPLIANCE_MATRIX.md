...
All accepted Sections 1–88 and AV-001–AV-249 remain controlling. AV-250–AV-294 are additive Phase 3 decisions and do not activate Candidate Daily or retire any legacy system. AV-271–AV-280 are later-controlling where R11 wording could otherwise permit mirroring deferred/rejected rows or clearing a non-terminal Availability recovery operation. AV-281–AV-294 are later-controlling for Master Rota durability, Google quota ownership and the product owner's population-wide TEST-enable decision; they supersede earlier one-candidate/one-cohort technical-gate wording.
