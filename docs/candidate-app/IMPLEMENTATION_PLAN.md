...
Status: active implementation; TEST-only. Updated: 10 August 2026. The DB/RPC authority is installed. The separate public Candidate broker and private CloudTMS Candidate API are implemented, published and deployed to TEST with every Candidate feature flag false. Runtime commit `2bf475c05e6fda6be68064b209f3e0398a26be6c` narrows rejection replacement to the exact claim identity—same contract-week record for hours/combined, same week-level expense family for expenses, and same DAILY booking/work date—and retires all delivery generations on one shared PAPER QR source as a locked set before economic-target rotation. Clean PostgreSQL 17.6 and 18.1 installs pass all 19 runtime/concurrency suites; 113/113 focused Candidate tests and 445/445 complete backend tests pass; all three Worker builds pass. GitHub runtime workflow `31435115913` and safe migration workflow `31435115904` passed; the exact repeatables are installed; all three TEST Workers were deployed and health/isolation checked. Independent re-audit remains the Stage 2 sign-off gate before CloudTMS frontend implementation and API freeze.
...
Current end-to-end closure verification: runtime commit `2bf475c05e6fda6be68064b209f3e0398a26be6c` passes 113/113 focused Candidate/backend/broker/DB tests and 445/445 complete backend tests. The full Candidate install and all 19 SQL runtime/concurrency suites pass on clean disposable PostgreSQL 17.6 and PostgreSQL 18.1 locally and in GitHub workflow `31435115913`. Safe migration workflow `31435115904` installed the exact changed repeatables in TEST. Ledger SHA-256 matches the exact published Git bytes: read projection `c96f23c1f85b2a57fa19b0f9c36836d6937af321913bb384338744de89bf12a6`, workflow/PAPER retirement `b7549954751259a4f5cab1243a1f3a825a0364e57af2191681605083475ceb6a`, and rejection authority `04c48a47a2fbf8c71a80a72abf0040aea77a53cbac22cedcb78af3ce76837499`. Installed definition checks prove one exact replacement helper, one source-set retirement helper, contract-week identity, current-token ownership, preserved workflow receipts and mandatory use of the set authority by rejection. Public broker, private Candidate API and normal backend builds pass. Deployed TEST versions are private API `47076223-7d1c-4b60-9003-484b4a42ebce`, public broker `d112cbf3-8bde-4289-ae07-36ac04eb16fd`, and normal TEST backend `9609585c-abfa-436c-9140-2a8b5e361dda`. Broker and normal-backend health/readiness are `200/200`; direct public Candidate routing on the normal backend is `404`, and direct workers.dev access to the private Worker remains unavailable. Post-deployment state remains 14/14 service-role-only Candidate RPCs, all Candidate flags false, auto-authorisation false, all seven Candidate tables empty and Candidate-bound mail empty. The current-decisions PDF requires no policy amendment because this correction implements its existing exact-record recovery, independent-expense, immutable-history and obsolete-PAPER-token rules.
