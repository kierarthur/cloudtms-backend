...
- Public broker: `test-cloudtms-candidate-broker`, active version `cdcbcf85-c6cb-4aea-b05d-0fb142382750`.
- Private API: `test-cloudtms-candidate-private-api`, active version `7d35175e-6e33-4bb0-a806-a125049e9442`, with `workers_dev = false` and service-binding access only.
- Normal backend: `test-cloudtms-backend`, active version `9d05bf7b-52da-446a-907c-1781c721c9ff`.
