-- LEGACY_UPGRADE repeatable-order preload.
--
...
-- first; the ordinary repeatable sequence reasserts it later in the same
-- release. This file changes no payment state, financial rule, or Policy X
-- authority.
