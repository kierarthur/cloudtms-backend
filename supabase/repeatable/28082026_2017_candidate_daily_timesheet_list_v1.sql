-- Repeatable CloudTMS function/view authority: candidate_daily_timesheet_list_v1
...
begin
  ...
  select coalesce(jsonb_agg(jsonb_build_object(
    ...
    'card',jsonb_build_object(
      ...
      'manager_approval_state',case d.detail#>>'{manager_approval,state}' when 'APPROVED' then 'MANAGER_APPROVED'
