-- Repeatable CloudTMS function/view authority: candidate_daily_rota_clear_key_precedence_v1
...
-- Extract JSON text before concatenation. PostgreSQL operator precedence otherwise
-- treats the combined value as the JSON operand and fails only on booked/blocked clears.
