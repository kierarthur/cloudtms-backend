-- Repeatable CloudTMS function/view authority: candidate_home_draft_identity_v1
-- Keep the home response lightweight while reporting and exactly identifying
-- server-side mutable drafts for device/server deduplication.
