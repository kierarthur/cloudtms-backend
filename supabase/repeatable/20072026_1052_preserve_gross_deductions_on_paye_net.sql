-- Preserve frozen PAYE gross-side deductions when PAYE net is entered.
-- Gross deductions are already reflected in the external PAYE net and must not
-- be capped, voided, or recreated from that net. Post-draft validation remains
-- frozen-artifact based; only net-side deductions are reprojected from PAYE net.
