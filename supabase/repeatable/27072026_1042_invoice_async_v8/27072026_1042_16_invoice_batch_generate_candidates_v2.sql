...
alter function public.invoice_batch_generate_candidates(jsonb) owner to postgres;
revoke all on function public.invoice_batch_generate_candidates(jsonb)
  from public,anon;
grant execute on function public.invoice_batch_generate_candidates(jsonb)
