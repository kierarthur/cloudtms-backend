create or replace function private._invoice_batch_issue_candidate_key_rows_v2(
  p_query jsonb,
...
alter function private._invoice_batch_issue_candidate_key_rows_v2(
  jsonb,timestamptz
) owner to postgres;
revoke all on function private._invoice_batch_issue_candidate_key_rows_v2(
  jsonb,timestamptz
) from public,anon,authenticated;
grant execute on function private._invoice_batch_issue_candidate_key_rows_v2(
  jsonb,timestamptz
) to service_role;

create or replace function private._invoice_batch_issue_candidate_keys_v2(
  p_query jsonb,
  p_now_utc timestamptz
) returns table(
  selection_key text,
...
alter function private._invoice_batch_issue_candidate_keys_v2(
  jsonb,timestamptz
) owner to postgres;
revoke all on function private._invoice_batch_issue_candidate_keys_v2(
  jsonb,timestamptz
) from public,anon,authenticated;
grant execute on function private._invoice_batch_issue_candidate_keys_v2(
  jsonb,timestamptz
) to service_role;
