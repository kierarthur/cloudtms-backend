...
begin
  ...
  for v_item in
    ...
    [
      ...
      {"table_name":"settings_defaults","bump_generate":true,"bump_issue":true,"fields":["vat_registration_number","agency_name","agency_logo","registered_address","company_reg_number","bank_name","bank_sort_code","bank_account_number","finance_email","hr_attach_to_invoice","ts_attach_to_invoice","invoice_document_presentation_json"]},
