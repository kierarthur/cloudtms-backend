-- Repeatable CloudTMS function/view authority: candidate_home_draft_counts_v1
-- Keep the home response lightweight while reporting server-side mutable drafts.
...
begin
  ...
  if p_candidate_id is not null then
    ...
    into v_draft_timesheet_count,v_draft_expense_count
