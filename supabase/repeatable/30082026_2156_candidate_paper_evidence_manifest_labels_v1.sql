-- Candidate paper evidence manifest-label authority v1. Retains the complete
-- expense finalisation signature/category authority and, for verified PAPER
-- returns only, preserves the server-owned manifest page name in Office evidence.
