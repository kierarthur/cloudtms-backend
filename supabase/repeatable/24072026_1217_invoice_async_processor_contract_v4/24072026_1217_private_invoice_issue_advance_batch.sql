-- CloudTMS Invoice Async V8/V2 Issue worker authority.
...
alter function private._invoice_issue_advance_batch(
  jsonb,timestamptz
) owner to postgres;
revoke all on function private._invoice_issue_advance_batch(
  jsonb,timestamptz
) from public,anon,authenticated;
grant execute on function private._invoice_issue_advance_batch(
  jsonb,timestamptz
) to service_role;
