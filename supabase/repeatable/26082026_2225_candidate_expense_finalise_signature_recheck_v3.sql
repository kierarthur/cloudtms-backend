-- Candidate expense finalisation signature authority v3. Retains the v2
-- category correction and refreshes the guarded row signature between the
-- hours and expense legs of one locked combined finalisation transaction.
