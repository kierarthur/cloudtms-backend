-- Complete replacement authority for Candidate expense placement category
-- evidence. Overall non-mileage totals are not a second OTHER category when
-- the canonical snapshot already identifies TRAVEL or ACCOMMODATION.
