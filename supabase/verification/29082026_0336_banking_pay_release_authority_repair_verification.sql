...
-- replay had replaced seven current routine bodies.  This verifier proves
...
BEGIN
  FOR v_expected IN
    SELECT *
    FROM (VALUES
      ('public.bulk_authorise_dataset_v1(jsonb)', '00bd21d9e513cf697304973b508e682eaeafcf91dedbfb2685f276ad161bfbed'),
