-- Verifies the exact Candidate-named legacy relation/RPC closure without
-- reading or mutating application rows.

do $candidate_named_legacy_security_verification$
declare
  v_count integer;
...
begin
  ...
  if v_count<>85 or v_service_missing<>7 or v_browser_executable<>0
     or v_hash<>'1058d64351f6e5cbbe572564d7c89b28' then
...
$candidate_named_legacy_security_verification$;
