...
-- The page ledger must accept the same build-global authority stream as the
-- fact relation. Keeping the existing constraint identity preserves the
-- locked catalogue count while making fresh installs executable.
